...
#define S_ISCHR(__m) (((m) & S_IFMT) == S_IFCHR)
#define S_ISDIR(__m) (((m) & S_IFMT) == S_IFDIR)
#define S_ISFIFO(__m) (((m) & S_IFMT) == S_IFIFO)
#define S_ISREG(__m) (((m) & S_IFMT) == S_IFREG)
#define S_ISLNK(__m) (((m) & S_IFMT) == S_IFLNK)
#define S_ISSOCK(__m) (((m) & S_IFMT) == S_IFSOCK)
