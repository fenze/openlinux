...
enum hsmp_message_ids {
	...
	HSMP_SET_AUTO_DF_PSTATE,	 /* 0Eh Enable DF P-State Performance Boost
					    algorithm */
	HSMP_GET_FCLK_MCLK,		 /* 0Fh Get FCLK and MEMCLK for current socket */
	HSMP_GET_CCLK_THROTTLE_LIMIT,	 /* 10h Get CCLK frequency limit in socket
					  */
	HSMP_GET_C0_PERCENT,		 /* 11h Get average C0 residency in socket */
	HSMP_SET_NBIO_DPM_LEVEL,	 /* 12h Set max/min LCLK DPM Level for a given
					    NBIO */
	HSMP_GET_NBIO_DPM_LEVEL,	 /* 13h Get LCLK DPM level min and max for a
					    given NBIO */
	HSMP_GET_DDR_BANDWIDTH,		 /* 14h Get theoretical maximum and current DDR
					    Bandwidth */
	HSMP_GET_TEMP_MONITOR,		 /* 15h Get socket temperature */
	HSMP_GET_DIMM_TEMP_RANGE,	 /* 16h Get per-DIMM temperature range and
					    refresh rate */
	HSMP_GET_DIMM_POWER,		 /* 17h Get per-DIMM power consumption */
	HSMP_GET_DIMM_THERMAL,		 /* 18h Get per-DIMM thermal sensors */
	HSMP_GET_SOCKET_FREQ_LIMIT,	 /* 19h Get current active frequency per
					    socket */
 ...
 */
static const struct hsmp_msg_desc hsmp_msg_desc_table[] __attribute__((unused)) = {
	/* RESERVED */
	{ 0, 0, HSMP_RSVD },
	...
	/*
	 * HSMP_GET_SOCKET_POWER_LIMIT_MAX, num_args = 0, response_sz =
	 * 1 output: args[0] = maximuam socket power limit in mWatts
	 */
	{ 0, 1, HSMP_GET },

	/*
	 * HSMP_SET_BOOST_LIMIT, num_args = 1, response_sz = 0
	 * input: args[0] = apic id[31:16] + boost limit value in
	 * MHz[15:0]
	 */
	{ 1, 0, HSMP_SET },
	 ...
	 * input: args[0] = nbioid[23:16] + max dpm level[15:8] + min
	 * dpm level[7:0]
	 */
	{ 1, 0, HSMP_SET },
	 ...
	 * Gbps[19:8] + bw in percentage[7:0]
	 */
	{ 0, 1, HSMP_GET },

	/*
	 * HSMP_GET_TEMP_MONITOR, num_args = 0, response_sz = 1
	 * output: args[0] = temperature in degree celsius. [15:8]
	 * integer part + [7:5] fractional part
	 */
	{ 0, 1, HSMP_GET },
	 ...
	 * input: args[0] = DIMM address[7:0]
	 * output: args[0] = temperature in degree celsius[31:21] +
	 * update rate in ms[16:8] + DIMM address[7:0]
	 */
	{ 1, 1, HSMP_GET },
	 ...
	 * 2 output: args[0] = lower 32 bits of the address output:
	 * args[1] = upper 32 bits of the address
	 */
	{ 0, 2, HSMP_GET },

	/*
	 * HSMP_SET_XGMI_PSTATE_RANGE, num_args = 1, response_sz = 0
	 * input: args[0] = min xGMI p-state[15:8] + max xGMI
	 * p-state[7:0]
	 */
	{ 1, 0, HSMP_SET },
