 ...
 * - ]
 * @SKL_CH_CFG_I2S_DUAL_STEREO_1: Stereo(L,R) in 4 slots, 2nd stream:[ -, -, L,
 * R ]
...
enum skl_tkn_dir { SKL_DIR_IN, SKL_DIR_OUT };

enum skl_tuple_type { SKL_TYPE_TUPLE, SKL_TYPE_DATA };
