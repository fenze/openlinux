...
enum ar_event_types { AR_EVENT_NONE = 0, AR_PGA_DAPM_EVENT };
 ...
 *						APM_SUB_GRAPH_PERF_MODE_LOW_POWER
 * = 1, APM_SUB_GRAPH_PERF_MODE_LOW_LATENCY = 2
 *
 ...
 * = 1, APM_SUB_GRAPH_SID_AUDIO_RECORD = 2, APM_SUB_GRAPH_SID_VOICE_CALL = 3
 *
 ...
 * = 2, APM_CONT_GRAPH_POS_STR_DEV = 3, APM_CONT_GRAPH_POS_GLOBAL_DEV = 4
 *
 ...
 *
 * %AR_TKN_U32_MODULE_HW_IF_IDX:		Interface index types for
 * I2S/LPAIF
 *
 ...
 *						IEC60958 PACKETIZED NON LINEAR =
 * 8, COMPR OVER PCM PACKETIZED = 7, IEC61937 PACKETIZED = 2, GENERIC COMPRESSED
 * = 5
 *
