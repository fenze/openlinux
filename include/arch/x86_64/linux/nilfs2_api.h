...
#define NILFS_CPINFO_FNS(flag, name)                                                 \
	static __inline__ int nilfs_cpinfo_##name(const struct nilfs_cpinfo *cpinfo) \
	{                                                                            \
...
#define NILFS_SUINFO_FNS(flag, name)                                             \
	static __inline__ int nilfs_suinfo_##name(const struct nilfs_suinfo *si) \
	{                                                                        \
...
#define NILFS_SUINFO_UPDATE_FNS(flag, name)                                                      \
	static __inline__ void nilfs_suinfo_update_set_##name(struct nilfs_suinfo_update *sup)   \
	{                                                                                        \
