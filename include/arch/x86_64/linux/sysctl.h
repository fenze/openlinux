...
#define CTL_MAXNAME                                     \
	10 /* how many path components do we allow in a \
...
enum {
	...
	KERN_ACPI_VIDEO_FLAGS = 71, /* int: flags for setting up video after
				       ACPI sleep */
...
enum {
	...
	VM_LOWMEM_RESERVE_RATIO = 20, /* reservation ratio for lower memory
					 zones */
