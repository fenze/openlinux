 ...
 * between the maximum and minimum luma transform block size
 ...
 * between the maximum and minimum size of coding blocks
 ...
 * columns partitioning the picture
 * @num_tile_rows_minus1: this value plus 1 specifies the number of tile rows
 * partitioning the picture
 * @column_width_minus1: this value plus 1 specifies the width of the each tile
 * column in units of coding tree blocks
 * @row_height_minus1: this value plus 1 specifies the height of the each tile
 * row in units of coding tree blocks
 ...
 *				   motion vector prediction candidates supported
 * in the slice subtracted from 5
 ...
 * divided by 2
 * @pic_struct: indicates whether a picture should be displayed as a frame or as
 * one or more fields
 ...
 * NumDeltaPocs[RefRpsIdx], can be used to parse the RPS data in slice headers
 *				   instead of skipping it with
 ...
 */
enum v4l2_av1_tx_mode { V4L2_AV1_TX_MODE_ONLY_4X4 = 0, V4L2_AV1_TX_MODE_LARGEST = 1, V4L2_AV1_TX_MODE_SELECT = 2 };
 ...
 * @buffer_removal_time: specifies the frame removal time in units of DecCT
 * clock ticks counted from the removal time of the last random access point for
