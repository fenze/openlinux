 ...
 * scan, nested array attribute containing an entry for each band, with the
 * entry being a list of supported rates as defined by IEEE 802.11 7.3.2.2 but
 ...
 * an empty nested attribute to disable this feature and delete the templates.
 *
 ...
 *	Defined by IEEE P802.11ay/D4.0 section 9.4.2.251, Table 13.
 * @NL80211_BAND_ATTR_S1G_MCS_NSS_SET: S1G capabilities, supported S1G-MCS and
 * NSS set subfield, as in the S1G information IE, 5 bytes
 ...
 *	tx power offset.
 * @NL80211_HE_OBSS_PD_ATTR_BSS_COLOR_BITMAP: bitmap that indicates the BSS
 * color values used by members of the SRG.
 * @NL80211_HE_OBSS_PD_ATTR_PARTIAL_BSSID_BITMAP: bitmap that indicates the
 * partial BSSID values used by members of the SRG.
 ...
 *	Allowed range: 0..10000 (TU = Time Unit). If set to 0, the feature is
 * disabled.
 ...
 *	26.17.2.3.2 (AP behavior for fast passive scanning). If set to 0, the
 * feature is disabled.
 * @NL80211_UNSOL_BCAST_PROBE_RESP_ATTR_TMPL: Unsolicited broadcast probe
 * response frame template (binary).
 *
 ...
 * driver, and userspace can skip some certain ranges. These skipped ranges
 * don't have SAR limitations, and they are same as setting the
...
enum nl80211_s1g_short_beacon_attrs {
	...
	NL80211_S1G_SHORT_BEACON_ATTR_MAX = __NL80211_S1G_SHORT_BEACON_ATTR_LAST - 1
};
