 ...
 * Reset values are: gamma_y[0] = 0x0000, gamma_y[1] = 0x0100, ... gamma_y[15] =
 * 0x0f00, gamma_y[16] = 0xfff
 *
 ...
 * increments (sampling points). gamma_dx0 is for the lower samples (1-8),
 * gamma_dx1 is for the higher samples (9-16). The reset values for both fields
 * is 0x44444444. This means that each sample is 4 units away from the previous
 * one on the x-axis.
 *
 * @gamma_dx0: gamma curve sample points definitions. Bits 0:2 for sample 1. Bit
 * 3 unused. Bits 4:6 for sample 2. bit 7 unused ... Bits 28:30 for sample 8.
 * Bit 31 unused
 * @gamma_dx1: gamma curve sample points definitions. Bits 0:2 for sample 9. Bit
 * 3 unused. Bits 4:6 for sample 10. bit 7 unused ... Bits 28:30 for sample 16.
 * Bit 31 unused
 */
 ...
 * V4L2_COLORFX_SEPIA, V4L2_COLORFX_SET_CBCR, V4L2_COLORFX_AQUA,
 * V4L2_COLORFX_EMBOSS, V4L2_COLORFX_SKETCH,   V4L2_COLORFX_BW,
 * V4L2_COLORFX_NEGATIVE
 * @color_sel: bits 0:2 - colors bitmask (001 - blue, 010 - green, 100 - red).
 *		bits 8:15 - Threshold value of the RGB colors for the color
 * selection effect.
 ...
 * with 4 bit integer and 7 bit fractional part, ranging from -8 (0x400) to
 * +7.992 (0x3FF). 0 is represented by 0x000 and a coefficient value of 1 as
 * 0x080.
...
/**
 * struct rkisp1_cif_isp_wdr_iref_config - Illumination reference config for
 * WDR.
 *
...
/**
 * struct rkisp1_ext_params_hst_config - RkISP1 extensible params Histogram
 * config
 *
 ...
 * subtraction). Identified by
 * :c:type:`RKISP1_EXT_PARAMS_BLOCK_TYPE_COMPAND_BLS`.
 *
 * @header: The RkISP1 extensible parameters header, see
 *	    :c:type:`rkisp1_ext_params_block_header`
