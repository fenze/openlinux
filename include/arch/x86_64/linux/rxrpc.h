...
enum rxrpc_cmsg_type {
	...
	RXRPC_EXCLUSIVE_CALL = 10,   /* Cs-: Call should be on exclusive
					connection */
	RXRPC_UPGRADE_SERVICE = 11,  /* Cs-: Request service upgrade for client
					call */
	RXRPC_TX_LENGTH = 12,	     /* -s-: Total length of Tx data */
	RXRPC_SET_CALL_TIMEOUT = 13, /* -s-: Set one or more call timeouts */
	RXRPC_CHARGE_ACCEPT = 14,    /* Ss-: Charge the accept pool with a user
					call ID */
...
#define RXKADILLEGALLEVEL \
	19270412 /* caller not authorised to use encrypted conns */
...
#define RXGK_BADLEVEL \
	1233242886 /* Unsupported or not permitted security level */
