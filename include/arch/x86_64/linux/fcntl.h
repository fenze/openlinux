...
#define AT_FDCWD                                \
	-100 /* Special value for dirfd used to \
...
#define AT_HANDLE_FID                                                     \
	0x200			      /* File handle is needed to compare \
...
#define AT_EXECVE_CHECK                              \
	0x10000 /* Only perform a check if execution \
		   would be allowed. */
