...
#define IDT77105_GETSTAT \
	_IOW('a', ATMIOC_PHYPRV + 2, struct atmif_sioc) /* get stats */
#define IDT77105_GETSTATZ                                                     \
	_IOW('a', ATMIOC_PHYPRV + 3, struct atmif_sioc) /* get stats and zero \
							 */
