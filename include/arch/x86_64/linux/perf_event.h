...
enum perf_branch_sample_type_shift {
	...
	PERF_SAMPLE_BRANCH_HW_INDEX_SHIFT = 17, /* save low level index of raw
						   branch records */

	PERF_SAMPLE_BRANCH_PRIV_SAVE_SHIFT = 18, /* save privilege mode */

	PERF_SAMPLE_BRANCH_COUNTERS_SHIFT = 19, /* save occurrences of events on
						   a branch */
...
enum {
	...
	PERF_BR_NON_SPEC_CORRECT_PATH = 2, /* Non-speculative but on correct
					      path */
...
enum perf_event_type {
	 ...
	 *	{ u64			transaction; } &&
	 * PERF_SAMPLE_TRANSACTION { u64			abi; # enum
	 * perf_sample_regs_abi u64			regs[weight(mask)]; } &&
	 * PERF_SAMPLE_REGS_INTR { u64			phys_addr;} &&
	 * PERF_SAMPLE_PHYS_ADDR { u64			cgroup;} &&
	 * PERF_SAMPLE_CGROUP { u64			data_page_size;} &&
	 * PERF_SAMPLE_DATA_PAGE_SIZE { u64			code_page_size;}
	 * && PERF_SAMPLE_CODE_PAGE_SIZE { u64			size; char
...
union perf_mem_data_src {
	__u64 val;
	struct {
		__u64 mem_rsvd : 18, mem_hops : 3, /* Hop level */
			mem_blk : 3,		   /* Access blocked */
			mem_snoopx : 2,		   /* Snoop mode, ext */
			mem_remote : 1,		   /* Remote */
			mem_lvl_num : 4, /* Memory hierarchy level number */
