...
#define BTRFS_INODE_FLAG_MASK                                              \
	(BTRFS_INODE_NODATASUM | BTRFS_INODE_NODATACOW |                   \
	 BTRFS_INODE_READONLY | BTRFS_INODE_NOCOMPRESS |                   \
	 BTRFS_INODE_PREALLOC | BTRFS_INODE_SYNC | BTRFS_INODE_IMMUTABLE | \
	 BTRFS_INODE_APPEND | BTRFS_INODE_NODUMP | BTRFS_INODE_NOATIME |   \
	 BTRFS_INODE_DIRSYNC | BTRFS_INODE_COMPRESS |                      \
...
#define BTRFS_BACKREF_REV_MASK \
	(((u64)BTRFS_BACKREF_REV_MAX - 1) << BTRFS_BACKREF_REV_SHIFT)
...
#define BTRFS_BLOCK_GROUP_RESERVED \
	(BTRFS_AVAIL_ALLOC_BIT_SINGLE | BTRFS_SPACE_INFO_GLOBAL_RSV)
