...
enum {
	 ...
	 * enabled, then the commands issued to the device to process an I/O
	 * with one of these hints set will have the duration limit index (dld
	 * field) set to the value of the hint.
	 */
