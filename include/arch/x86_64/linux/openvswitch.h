...
#define OVS_CS_F_RELATED                                     \
	0x04			/* Related to an established \
				 * connection. */
#define OVS_CS_F_REPLY_DIR 0x08 /* Flow is in the reply direction. */
#define OVS_CS_F_INVALID   0x10 /* Could not track connection. */
#define OVS_CS_F_TRACKED   0x20 /* Conntrack has occurred. */
#define OVS_CS_F_SRC_NAT                         \
	0x40 /* Packet's source address/port was \
	      * mangled by NAT.                  \
	      */
#define OVS_CS_F_DST_NAT                          \
	0x80 /* Packet's destination address/port \
	      * was mangled by NAT.               \
	      */
...
#define OVS_MPLS_L3_TUNNEL_FLAG_MASK              \
	(1 << 0) /* Flag to specify the place of  \
