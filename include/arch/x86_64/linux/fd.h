...
#define FD_INVERTED_DCL                           \
	 ...
	 * used in succession to try to read the disk. If the FDC cannot lock
	 * onto the disk, the next format is tried. This uses the variable
	 * 'probing'.
	 */
...
#define FD_DISK_WRITABLE  (1 << FD_DISK_WRITABLE_BIT)
	...
	/*
	 * (User-provided) media information is _not_ discarded after a media
	 * change if the corresponding keep_data flag is non-zero. Positive
	 * values are decremented after each probe.
	 */
	int keep_data;
