 ...
 * <4,1,0,281> Sonic Systems Ethernet A-Series Card: <4,1,268,256> Asante MacCon
 * NuBus-A: <4,1,260,256> (alpha-1.0,1.1 revision) ROM on the above card:
 * <2,1,0,0> Cabletron ethernet card: <4,1,1,265> Farallon ethernet card:
 * <4,1,268,256> (identical to Sonic Systems card) Kinetics EtherPort IIN:
 * <4,1,259,262> API Engineering EtherRun_LCa PDS enet card: <4,1,282,256>
 *
