...
#define VK_FWSTS_READY                                               \
	(VK_FWSTS_INIT_START | VK_FWSTS_ARCH_INIT_DONE |             \
	 VK_FWSTS_PRE_KNL1_INIT_DONE | VK_FWSTS_PRE_KNL2_INIT_DONE | \
	 VK_FWSTS_POST_KNL_INIT_DONE | VK_FWSTS_INIT_DONE |          \
	 VK_FWSTS_APP_INIT_START | VK_FWSTS_APP_INIT_DONE)
/* Deinit */
...
#define VK_FWSTS_DEINIT_TRIGGERED                               \
	(VK_FWSTS_APP_DEINIT_START | VK_FWSTS_APP_DEINIT_DONE | \
	 VK_FWSTS_DRV_DEINIT_START | VK_FWSTS_DRV_DEINIT_DONE)
