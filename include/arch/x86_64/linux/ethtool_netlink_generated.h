...
enum {
	...
	ETHTOOL_A_TS_HWTSTAMP_PROVIDER_MAX =
		(__ETHTOOL_A_TS_HWTSTAMP_PROVIDER_CNT - 1)
};
...
enum {
	...
	ETHTOOL_A_CABLE_TEST_TDR_CFG_MAX =
		(__ETHTOOL_A_CABLE_TEST_TDR_CFG_CNT - 1)
};
...
enum {
	...
	ETHTOOL_A_CABLE_TEST_TDR_NTF_MAX =
		(__ETHTOOL_A_CABLE_TEST_TDR_NTF_CNT - 1)
};
...
enum {
	...
	__ETHTOOL_A_C33_PSE_PW_LIMIT_MAX =
		(__ETHTOOL_A_C33_PSE_PW_LIMIT_CNT - 1)
};
